...
(defun emacs_start__with_tangled()
  (progn
    (defun my/tangle-dotfiles ()
      ...
      (when (equal (buffer-file-name) (expand-file-name "~/.emacs.d_kadir/README.org"))
        (org-babel-tangle nil "~/.emacs.d_kadir/README.el")
        ;; (byte-compile-file "~/.emacs.d/README.el")
        ))
    (add-hook 'after-save-hook #'my/tangle-dotfiles)
    (load-file "~/.emacs.d_kadir/README.el")))


(if (most-recent-p  "~/.emacs.d_kadir/README.org" "~/.emacs.d_kadir/README.el")
